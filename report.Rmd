...
Die Notbremse ```r df.notbremse[df.notbremse["county_name"] == "Münster","notbremse"]``` für Münster. Laut den täglich gemeldeten Daten liegt die 7-Tage-Inzidenz für Münster seit ```r df.notbremse[df.notbremse["county_name"] == "Münster", "days_since"]``` Werktag(en) unter 100. Die errechnete Inzidenz ist in Münster durchschnittlich um ```r mean_delta_reported_calculated```% höher, als die täglich gemeldete.
